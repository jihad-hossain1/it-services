    ...
    const testimonials = [
        {
            ...
            comment: "Partnering with ItTechSolutions has been instrumental in our company's technological advancement.Their expertise and dedication have helped us overcome complex challenges and stay ahead of the curve in a competitive market.",
        ...
        },
        {
            ...
            comment: "I can't speak highly enough of the support we've received from ItTechSolutions. Their responsive team and tailored solutions have significantly improved our operational efficiency, allowing us to focus on driving business growth.",
        ...
        },
        {
            ...
            comment: "Choosing ItTechSolutions for our IT services has proven to be a wise investment. Their cost-effective solutions and strategic guidance have not only optimized our IT infrastructure but also contributed to our bottom line.",
        ...
        },
        {
            ...
            comment: "Working with ItTechSolutions has been a game-changer for our marketing efforts. Their innovative solutions and collaborative approach have helped us execute campaigns with precision and achieve remarkable results.",
        ...
        },
        {
            ...
            comment: "At Growth Industries, our employees are our greatest asset. ItTechSolutions has played a crucial role in ensuring our team feels supported and empowered through their seamless IT solutions and exceptional customer service.",
        ...
        },
        {
            ...
            comment: "I've been consistently impressed with the level of professionalism and expertise demonstrated by ItTechSolutions. Their proactive approach to IT support has minimized disruptions and optimized our operations, allowing us to deliver exceptional service to our clients.",
        ...
        },
        {
            ...
            comment: "As an IT manager, I rely on reliable partners to support our infrastructure. ItTechSolutions has consistently exceeded our expectations with their proactive approach and innovative solutions. Their team feels like an extension of ours.",
            ...
            >
                {testimonials.map((testimonial, index) => (
                    <SwiperSlide key={index} className="testimonial-swiper flex flex-col items-center justify-center text-center bg-gray-50 px-5 py-10 rounded shadow-md my-20">
                        ...
                        <p className="text-gray-700 mb-10 leading-relaxed text-justify">{testimonial.comment}</p>
