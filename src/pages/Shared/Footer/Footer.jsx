...
const Footer = () => {
  ...
  return (
    <div className='mt-20 bg-black'>
      <footer className="my-container footer p-10 bg-black text-white">
        <div>
          <span className="footer-title">Services</span>
          {
            servicesData?.map(footer => <><Link to={footer?.href} className="link link-hover">{footer.title}</Link>
            </>)
          }
        </div>
        <div>
      ...
      <footer className="my-container footer px-10 py-4 border-t bg-black text-white border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p>ItTechSolutions. <br />Providing reliable tech since 2020</p>
        </div>
